    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-white mt-1">
          <ul class="navbar-nav mr-auto mt-6 mt-lg-0">
            ...
            <li class="nav-item active mr-5">
              <a class="nav-link" href="http://localhost/project/products.php">Products</a>
            </li>
            <li class="nav-item active mr-5">
                <a class="nav-link" href="http://localhost/project/contact.php">Contact Us</a>
              </li>
          </ul>
            </div>
          </nav>
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="s3.jpg" alt="Chicago" width="1100" height="400">
          </div>
          <div class="carousel-item">
            <img src="s1.png" alt="New York" width="1100" height="400">
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="panel panel-primary">
              ...
              <div class="panel-body"><a href="productdetails.html">
                <img src="p1.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
              <div class="panel-footer"><b>Buy New Iphone 11 Pro</b></div>
            </div>
          </div>
          <div class="col-sm-4"> 
            <div class="panel panel-danger">
              ...
              <div class="panel-footer">Men Shoes Sale</div>
            </div>
          </div>
          <div class="col-sm-4"> 
            <div class="panel panel-success">
              <div class="panel-heading"></div>
              <div class="panel-body"><img src="p3.jpg" class="img-responsive" style="width:100%" alt="Image" height="220"></div>
              <div class="panel-footer">Sports Eqiupments Here</div>
            </div>
          </div>
        </div>
      </div><br>
